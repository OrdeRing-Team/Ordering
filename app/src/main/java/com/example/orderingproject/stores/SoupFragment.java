...
import com.example.orderingproject.databinding.FragmentPizzaBinding;
import com.example.orderingproject.databinding.FragmentSnackBarBinding;
import com.example.orderingproject.databinding.FragmentSoupBinding;
...
public class SoupFragment extends Fragment {
    ...
    private static final FoodCategory JJIM_TANG = FoodCategory.JJIM_TANG;
    private FragmentSoupBinding binding;
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refreshStoreList();
        getStoreListFromServer(FoodCategory.JJIM_TANG);
                                ...
                                if (result.getData() != null) {
                                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // 리사이클러뷰 연결
                                            RecyclerView recyclerView = binding.soupList;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getStoreListFromServer(JJIM_TANG);
