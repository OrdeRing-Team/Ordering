...
public class JapaneseFoodFragment extends Fragment {
    ...
    private static final FoodCategory PORK_CUTLET_ROW_FISH_SUSHI = FoodCategory.PORK_CUTLET_ROW_FISH_SUSHI;
    private FragmentJapaneseFoodBinding binding;
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refreshStoreList();
        getStoreListFromServer(FoodCategory.PORK_CUTLET_ROW_FISH_SUSHI);
                                ...
                                if (result.getData() != null) {
                                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // 리사이클러뷰 연결
                                            RecyclerView recyclerView = binding.japaneseFoodList;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getStoreListFromServer(PORK_CUTLET_ROW_FISH_SUSHI);
