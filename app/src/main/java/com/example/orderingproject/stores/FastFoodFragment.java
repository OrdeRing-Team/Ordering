...
public class FastFoodFragment extends Fragment {
    ...
    private static final FoodCategory FAST_FOOD = FoodCategory.FAST_FOOD;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refreshStoreList();
        getStoreListFromServer(FoodCategory.FAST_FOOD);
                                ...
                                if (result.getData() != null) {
                                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // 리사이클러뷰 연결
                                            RecyclerView recyclerView = binding.fastFoodList;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getStoreListFromServer(FAST_FOOD);
