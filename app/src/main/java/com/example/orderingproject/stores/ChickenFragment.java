...
public class ChickenFragment extends Fragment {
    ...
    private static final FoodCategory CHICKEN = FoodCategory.CHICKEN;
    private FragmentChickenBinding binding;
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        refreshStoreList();
        getStoreListFromServer(FoodCategory.CHICKEN);
                                ...
                                if (result.getData() != null) {
                                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // 리사이클러뷰 연결
                                            RecyclerView recyclerView = binding.chickenList;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getStoreListFromServer(CHICKEN);
