...
public class AsianWesternFoodFragment extends Fragment {
    ...
    private static final FoodCategory ASIAN_FOOD_WESTERN_FOOD = FoodCategory.ASIAN_FOOD_WESTERN_FOOD;
    private FragmentAsianWesternFoodBinding binding;
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAsianWesternFoodBinding.inflate(inflater, container, false);
        v = binding.getRoot();
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getStoreListFromServer(ASIAN_FOOD_WESTERN_FOOD);
